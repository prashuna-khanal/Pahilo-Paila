...
public class Dashboard_JobSeekers extends javax.swing.JFrame {
    ...
    // Method to create a notification icon using Graphics2D
        ...
        JLabel label = new JLabel(text) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (this == dashboard && dashboardPressed || this == vacancy && vacancyPressed ||
                    this == CV && CVPressed || this == settings && settingsPressed ||this == notifications && notificationsPressed ||
                    this == myAccount && myAccountPressed || this == signOut && signOutPressed) {
                    g2d.setColor(pressedBg);
                } else if (this == dashboard && dashboardHovered || this == vacancy && vacancyHovered ||this == notifications && notificationsHovered ||
    ...
    private void initComponents() {
        ...
        notifications = createStyledLabel("Notifications", null); // Use custom notification icon
            ...
            featurePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(featurePanelLayout.createSequentialGroup()
                    ...
                    .addGroup(featurePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(notifications, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        featurePanelLayout.setVerticalGroup(
            featurePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(featurePanelLayout.createSequentialGroup()
                    ...
                    .addComponent(notifications, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
